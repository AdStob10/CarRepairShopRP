        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productionYear = table.Column<long>(type: "bigint", nullable: false),
                    EngineCapacity = table.Column<int>(type: "int", nullable: false),
                    EngineFuel = table.Column<int>(type: "int", nullable: false),
                    oilChangeDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProblemDescription = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    RepairState = table.Column<int>(type: "int", nullable: true),
                    startTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WorkPrice = table.Column<decimal>(type: "money", nullable: false),
                    CarID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repair_AspNetUsers_AssignedMechanicID",
                        column: x => x.AssignedMechanicID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Repair_AspNetUsers_ClientID",
                        column: x => x.ClientID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplacedPart", x => x.ReplacedPartID);
                    table.ForeignKey(
                        name: "FK_ReplacedPart_Repair_RepairID",
                        column: x => x.RepairID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Repair_AssignedMechanicID",
                table: "Repair",
